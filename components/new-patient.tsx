...
// import { PrismaClient, Patient } from "@/lib/generated/prisma";
...
//   // ✅ Pull user info from Clerk if present
//   const userData = {
...
//   // You will need to implement onSubmit here
...
import { useUser } from "@clerk/nextjs";
import { Patient ,PrismaClient} from "@/lib/generated/prisma";
...
import { GENDER, MARITAL_STATUS, RELATION } from "@/lib";
import { Button } from "./ui/button";
import { createNewPatient, updatePatient } from "../lib/action/patient";
...
export const NewPatient = ({ userId,  data, type }: DataProps) => {
  ...
  const form = useForm<z.infer<typeof PatientFormSchema>>({
    ...
    defaultValues: {
      ...
      allergies: "",
      medical_conditions: "",
      last_admitted_hospital: "",
      last_admission_date: new Date(),
      admission_reason: "",
      medical_history: "",
    },
  });
    ...
    if (type === "create") {
      ...
      data &&
        form.reset({
          ...
          medical_conditions: data?.medical_conditions! || "",
          medical_history: data?.medical_history! || "",
          last_admitted_hospital: data. last_admitted_hospital! || "",
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col lg:flex-row  gap-y-6 items-center gap-2 md:gap-4">
                <CustomInput
                  type="input"
                  control={form.control}
                  name="last_admitted_hospital"
                  placeholder="Last Admitted Hospital"
                  label="Last Admitted Hospital"
                />{" "}
                <CustomInput
                     type="input"
                     inputType="date" // This sets <input type="date" />
                     control={form.control}
                     name="last_admission_date"
