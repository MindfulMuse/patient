//E:\Projects\patient monitor\patient monitor\my-app\app\(protected)\patient\registration\page.tsx
  ...
  return (
    <div className="w-full h-full flex justify-center">
      <div className="max-w-6xl w-full relative pb-10">
        <NewPatient userId={userId!} data={data!} type={!data ? "create" : "update"} />
      </div>
    </div>
  );
};
