...
{  const { email } = await params;
  ...
  const Nurse = await prisma.nurse.findUnique({
    ...
    include: { NurseAssignment: { include: { Patient: true } } },
  });

  const isAssigned = Nurse?.NurseAssignment.some(
    (assignment) => assignment.Patient.email === patientEmail
  );
