      ...
      <Table className="min-w-full divide-y divide-gray-200 text-sm">
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="hidden lg:table-cell">Oxygen Saturation</TableHead>
            <TableHead className="hidden lg:table-cell">SBP</TableHead>
            <TableHead className="hidden lg:table-cell">DBP</TableHead>
            <TableHead className="hidden lg:table-cell">SI</TableHead>
            <TableHead className="hidden lg:table-cell">RI</TableHead>
            <TableHead className="hidden lg:table-cell">PI</TableHead>
            <TableHead className="hidden lg:table-cell">Blood Pressure</TableHead>
